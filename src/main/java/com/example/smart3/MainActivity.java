...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 액션바에 추가될 탭 생성
        ActionBar.Tab tab1 = bar.newTab().setText("HOME").setTabListener(tabListener);
        ActionBar.Tab tab2 = bar.newTab().setText("TIME1").setTabListener(tabListener);
        ActionBar.Tab tab3 = bar.newTab().setText("TIME2").setTabListener(tabListener);
        ...
        fList.add(home1.newInstance());
        fList.add(home2_timeset.newInstance());
        fList.add(home3_timeset.newInstance());
